...
const Navbar = () => {
  return (
    <div className="navbar bg-base-100">
      ...
      <Link to={'/'} className="hidden sm:block"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<Link className="px-3 hidden sm:block" to='/'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
